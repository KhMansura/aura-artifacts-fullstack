...
//             <div className="absolute -top-4 -left-4 w-64 h-64 bg-amber-100 rounded-full blur-3xl opacity-60"></div>
...
//             <h4 className="text-amber-600 font-bold uppercase tracking-[0.3em] text-sm">Since 1995</h4>
//             <h2 className="text-5xl font-black text-slate-900 leading-tight">
//               Curating the World&apos;s <br /> 
//               <span className="text-amber-500">Rarest Treasures</span>
//             </h2>
...
//                 <p className="text-sm font-bold text-gray-400 uppercase">Years Exp.</p>
//               </div>
//               <div>
//                 <p className="text-3xl font-black text-slate-900">10k+</p>
//                 <p className="text-sm font-bold text-gray-400 uppercase">Artifacts</p>
//               </div>
//             </div>
//           </div>
